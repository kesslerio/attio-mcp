        ...
        try {
            if (toolName === "search-companies") {
                ...
                try {
                    ...
                    return createErrorResult(error instanceof Error ? error : new Error("Unknown error"), "/objects/companies/records/query", "GET", error.response?.data || {});
                }
            }
            if (toolName === "read-company-details") {
                ...
                try {
                    ...
                    return createErrorResult(error instanceof Error ? error : new Error("Unknown error"), `/objects/companies/records/${companyId}`, "GET", error.response?.data || {});
                }
            }
            if (toolName === "read-company-notes") {
                ...
                try {
                    ...
                    return createErrorResult(error instanceof Error ? error : new Error("Unknown error"), `/notes?parent_object=companies&parent_record_id=${companyId}`, "GET", error.response?.data || {});
                }
            }
